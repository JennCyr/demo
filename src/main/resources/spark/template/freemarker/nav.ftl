      ...
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><span class="glyphicon glyphicon-info-sign"></span> Getting Started Guides <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="https://devcenter.heroku.com/articles/getting-started-with-java">Hello MC Analytics!!!</a></li>
            ...
            <li><a href="https://devcenter.heroku.com/articles/getting-started-with-scala">Get Started with Scala on Heroku</a></li>
            <li class="divider"></li>
